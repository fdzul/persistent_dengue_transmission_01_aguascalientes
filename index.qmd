...
/* Contenedor principal con scroll - DOS COLUMNAS */
.responsive-grid {
  display: grid;
...
</div><div class="columna"><div class="column-header"> 🔄 CADENAS DE TRANSMISIÓN DE DENGUE </div>
...
# [**Mapas de Calor**]{style="font-size:2pt"}
